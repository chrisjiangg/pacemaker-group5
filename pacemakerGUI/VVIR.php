...
<body>
    ...
    <h2>Change Parameters</h2>
        ...
        <form method="post">
            ...
            Maximum Sensing Rate (ppm): <input type="range" name="maximum_sensor_rate" placeholder= "Maximum Sensing Rate" min="50" max="175" step="1" value="<?php echo $maximum_sensor_rate?>" oninput="rangeValue9.innerText = this.value" required>
            <br>
            ...
            Hysteresis (ppm): <input type="range" name="hysteresis" placeholder="Hysteresis" min = "0" max = "175" step= "<?php echo $hysteresis?>" value="0" oninput="rangeValue7.innerText = this.value" required>
            <br>
            ...
            Reaction Time (sec): <input type="range" name="reaction_time" placeholder= "Reaction Time" min="10" max="50" step="10" value="<?php echo $reaction_time?>" oninput="rangeValue11.innerText = this.value" required>
            <br>
