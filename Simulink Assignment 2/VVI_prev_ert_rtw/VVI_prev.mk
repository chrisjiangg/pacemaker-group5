###########################################################################
## Makefile generated for component 'VVI_prev'. 
## 
## Makefile     : VVI_prev.mk
## Generated on : Thu Nov 24 18:40:24 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/VVI_prev.elf
...
COMPILER_COMMAND_FILE     = VVI_prev_comp.rsp
CMD_FILE                  = VVI_prev.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/VVI_prev.elf
...
DEFINES_STANDARD = -DMODEL=VVI_prev -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/VVI_prev_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/VVI_prev_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/VVI_prev_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/VVI_prev_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/VVI_prev_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/VVI_prev_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


VVI_prev.o : $(START_DIR)/VVI_prev_ert_rtw/VVI_prev.c
	$(CC) $(CFLAGS) -o "$@" "$<"


VVI_prev_data.o : $(START_DIR)/VVI_prev_ert_rtw/VVI_prev_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
